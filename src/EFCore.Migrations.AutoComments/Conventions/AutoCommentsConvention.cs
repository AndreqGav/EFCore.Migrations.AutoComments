...
internal class AutoCommentsConvention : IModelFinalizingConvention
{
    ...
    private void SetEntityComments(IConventionModelBuilder modelBuilder)
    {
        ...
        foreach (var entityType in tableTypes)
        {
            ...
            {
                _logger.LogDebug("AutoComments: skipping entity {Entity} вЂ” comment already configured", entityType.ClrType.Name);
            ...
            _logger.LogDebug("AutoComments: entity {Entity} вЂ” comment {Status}", entityType.ClrType.Name,
    ...
    private void SetOwnedTypes(IConventionModelBuilder modelBuilder)
    {
        ...
        foreach (var ownedEntityType in ownedEntityTypes)
        {
            ...
            {
                _logger.LogDebug("AutoComments: skipping owned type {Entity} вЂ” comment already configured", ownedEntityType.ClrType.Name);
    ...
    private void SetColumnComments(IConventionModelBuilder modelBuilder)
    {
        ...
        void HandleProperty(IConventionProperty property)
        {
            ...
            {
                _logger.LogDebug("AutoComments: skipping column {Entity}.{Property} вЂ” comment already configured",
            ...
            _logger.LogDebug("AutoComments: column {Entity}.{Property} вЂ” comment {Status}",
