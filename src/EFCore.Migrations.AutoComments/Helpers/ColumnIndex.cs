...
internal class ColumnIndex
{
    ...
    public static ColumnIndex Build(IEnumerable<IConventionEntityType> entityTypes)
    {
        ...
        foreach (var entityType in entityTypes)
        {
            ...
            {
                var store = StoreObjectIdentifier.Create(property.DeclaringType, StoreObjectType.Table);
    ...
    /// </summary>
    private static IEnumerable<IConventionProperty> GetFlattenedProperties(IConventionTypeBase typeBase)
    {
